...
" Vim session script.
" Created by session.vim 2.13.1 on 15 Tháng 6 2021 at 16:49:43.
...
setlocal fen
silent! normal! zE
let s:l = 74 - ((8 * winheight(0) + 26) / 53)
...
1resize 53|vert 1resize 31|2resize 53|vert 2resize 95|3resize 53|vert 3resize 94|
2wincmd w
tabnext 1
if exists('s:wipebuf')
