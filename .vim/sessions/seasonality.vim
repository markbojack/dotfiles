...
" Vim session script.
" Created by session.vim 2.13.1 on 05 Tháng 5 2021 at 10:44:46.
...
badd +198 R/h-report.R
badd +2 prev-performance.R
...
badd +151 data/high-sharpe/shorts
argglobal
%argdel
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 94 + 110) / 221)
exe 'vert 2resize ' . ((&columns * 126 + 110) / 221)
argglobal
if bufexists("term://.//56053:R\ ") | buffer term://.//56053:R\  | else | edit term://.//56053:R\  | endif
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
setlocal fdn=20
setlocal fen
let s:l = 1030 - ((52 * winheight(0) + 26) / 53)
