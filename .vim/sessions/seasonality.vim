...
" Vim session script.
" Created by session.vim 2.13.1 on 27 Tháng 5 2021 at 13:59:28.
...
exe 'vert 3resize ' . ((&columns * 79 + 110) / 221)
argglobal
enew
" file NERD_tree_2
setlocal fdm=manual
...
setlocal fdn=20
setlocal fen
let s:l = 10009 - ((44 * winheight(0) + 26) / 53)
...
setlocal fen
silent! normal! zE
let s:l = 125 - ((12 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
125
...
1resize 53|vert 1resize 31|2resize 53|vert 2resize 109|3resize 53|vert 3resize 79|
3wincmd w
tabnext 1
if exists('s:wipebuf')
