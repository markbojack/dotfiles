...
" Vim session script.
" Created by session.vim 2.13.1 on 28 Tháng 5 2021 at 11:52:12.
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 90 + 110) / 221)
exe 'vert 2resize ' . ((&columns * 130 + 110) / 221)
argglobal
if bufexists("term://.//16018:R\ ") | buffer term://.//16018:R\  | else | edit term://.//16018:R\  | endif
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
setlocal fdn=20
setlocal fen
let s:l = 1716 - ((35 * winheight(0) + 26) / 53)
...
setlocal fen
silent! normal! zE
let s:l = 64 - ((8 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
64
