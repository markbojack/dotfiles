...
" Vim session script.
" Created by session.vim 2.13.1 on 22 Tháng 6 2021 at 15:19:37.
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 26 + 110) / 220)
exe 'vert 2resize ' . ((&columns * 193 + 110) / 220)
argglobal
enew
" file NERD_tree_3
setlocal fdm=manual
...
1resize 53|vert 1resize 26|2resize 53|vert 2resize 193|
2wincmd w
tabnext 1
if exists('s:wipebuf')
