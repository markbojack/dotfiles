...
" Vim session script.
" Created by session.vim 2.13.1 on 07 Tháng 6 2021 at 12:46:39.
...
argglobal
if bufexists("term://.//1156839:R\ ") | buffer term://.//1156839:R\  | else | edit term://.//1156839:R\  | endif
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
setlocal fdn=20
setlocal fen
let s:l = 1187 - ((52 * winheight(0) + 26) / 53)
...
setlocal fen
silent! normal! zE
let s:l = 69 - ((19 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
69
