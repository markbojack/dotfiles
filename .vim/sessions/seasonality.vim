...
" Vim session script.
" Created by session.vim 2.13.1 on 26 Tháng 5 2021 at 00:16:38.
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 82 + 110) / 221)
exe 'vert 2resize ' . ((&columns * 138 + 110) / 221)
argglobal
...
setlocal fen
silent! normal! zE
let s:l = 51 - ((8 * winheight(0) + 29) / 58)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
51
