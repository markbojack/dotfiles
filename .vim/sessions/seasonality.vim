...
" Vim session script.
" Created by session.vim 2.13.1 on 27 Tháng 5 2021 at 22:58:43.
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 97 + 110) / 221)
exe '2resize ' . ((&lines * 26 + 27) / 55)
exe 'vert 2resize ' . ((&columns * 123 + 110) / 221)
exe '3resize ' . ((&lines * 26 + 27) / 55)
exe 'vert 3resize ' . ((&columns * 123 + 110) / 221)
argglobal
...
setlocal fdn=20
setlocal fen
let s:l = 3930 - ((52 * winheight(0) + 26) / 53)
...
setlocal fen
silent! normal! zE
let s:l = 90 - ((20 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
90
