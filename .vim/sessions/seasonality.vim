...
" Vim session script.
" Created by session.vim 2.13.1 on 27 Tháng 5 2021 at 16:14:00.
...
setlocal fdn=20
setlocal fen
let s:l = 10029 - ((28 * winheight(0) + 26) / 53)
...
setlocal fen
silent! normal! zE
let s:l = 194 - ((23 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
194
