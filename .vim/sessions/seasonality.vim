...
" Vim session script.
" Created by session.vim 2.13.1 on 26 Tháng 5 2021 at 13:59:25.
...
exe 'vert 3resize ' . ((&columns * 104 + 110) / 221)
exe '4resize ' . ((&lines * 26 + 27) / 55)
exe 'vert 4resize ' . ((&columns * 104 + 110) / 221)
argglobal
enew
" file NERD_tree_3
setlocal fdm=manual
...
wincmd w
argglobal
if bufexists("term://.//2548570:R\ ") | buffer term://.//2548570:R\  | else | edit term://.//2548570:R\  | endif
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
wincmd w
argglobal
if bufexists("R/h-report.R") | buffer R/h-report.R | else | edit R/h-report.R | endif
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
setlocal fen
silent! normal! zE
let s:l = 20 - ((14 * winheight(0) + 13) / 26)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
20
...
1resize 53|vert 1resize 31|2resize 53|vert 2resize 84|3resize 26|vert 3resize 104|4resize 26|vert 4resize 104|
4wincmd w
tabnext 1
if exists('s:wipebuf')
