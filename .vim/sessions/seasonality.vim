...
" Vim session script.
" Created by session.vim 2.13.1 on 05 Tháng 5 2021 at 18:59:46.
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 65 + 77) / 154)
exe 'vert 2resize ' . ((&columns * 88 + 77) / 154)
argglobal
if bufexists("term://.//579956:R\ ") | buffer term://.//579956:R\  | else | edit term://.//579956:R\  | endif
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
setlocal fdn=20
setlocal fen
let s:l = 1203 - ((45 * winheight(0) + 26) / 53)
