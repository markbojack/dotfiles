...
" Vim session script.
" Created by session.vim 2.13.1 on 26 Tháng 5 2021 at 09:59:12.
...
argglobal
if bufexists("term://.//55874:R\ ") | buffer term://.//55874:R\  | else | edit term://.//55874:R\  | endif
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
setlocal fdn=20
setlocal fen
let s:l = 1978 - ((52 * winheight(0) + 26) / 53)
...
setlocal fen
silent! normal! zE
let s:l = 81 - ((44 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
81
