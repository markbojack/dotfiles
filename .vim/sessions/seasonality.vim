...
" Vim session script.
" Created by session.vim 2.13.1 on 25 Tháng 5 2021 at 17:01:02.
...
exe 'vert 2resize ' . ((&columns * 99 + 110) / 221)
exe 'vert 3resize ' . ((&columns * 40 + 110) / 221)
argglobal
if bufexists("term://.//3710176:R\ ") | buffer term://.//3710176:R\  | else | edit term://.//3710176:R\  | endif
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
setlocal fdn=20
setlocal fen
let s:l = 4997 - ((52 * winheight(0) + 26) / 53)
...
setlocal fen
silent! normal! zE
let s:l = 497 - ((29 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
497
