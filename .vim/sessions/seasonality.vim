...
" Vim session script.
" Created by session.vim 2.13.1 on 14 Tháng 6 2021 at 21:58:59.
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 80 + 54) / 108)
exe 'vert 2resize ' . ((&columns * 27 + 54) / 108)
argglobal
if bufexists("term://.//1801524:R\ ") | buffer term://.//1801524:R\  | else | edit term://.//1801524:R\  | endif
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
setlocal fdn=20
setlocal fen
let s:l = 1213 - ((52 * winheight(0) + 26) / 53)
...
setlocal fen
silent! normal! zE
let s:l = 83 - ((31 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
83
