...
" Vim session script.
" Created by session.vim 2.13.1 on 06 Tháng 5 2021 at 23:59:08.
...
badd +42 R/h-report.R
badd +82 prev-performance.R
...
set winminwidth=0
set winwidth=1
exe 'vert 1resize ' . ((&columns * 72 + 110) / 221)
exe 'vert 2resize ' . ((&columns * 103 + 110) / 221)
exe 'vert 3resize ' . ((&columns * 44 + 110) / 221)
argglobal
if bufexists("term://.//1199483:R\ ") | buffer term://.//1199483:R\  | else | edit term://.//1199483:R\  | endif
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
setlocal fdn=20
setlocal fen
let s:l = 2637 - ((52 * winheight(0) + 26) / 53)
...
setlocal fen
silent! normal! zE
let s:l = 60 - ((37 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
60
...
wincmd w
argglobal
if bufexists(".scratchpads/scratchpad.R") | buffer .scratchpads/scratchpad.R | else | edit .scratchpads/scratchpad.R | endif
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
