...
" Vim session script.
" Created by session.vim 2.13.1 on 15 Tháng 6 2021 at 14:45:56.
...
exe 'vert 2resize ' . ((&columns * 190 + 111) / 222)
argglobal
enew
" file NERD_tree_3
setlocal fdm=manual
...
setlocal fen
silent! normal! zE
let s:l = 40 - ((14 * winheight(0) + 26) / 53)
...
1resize 53|vert 1resize 31|2resize 53|vert 2resize 190|
2wincmd w
tabnext 1
if exists('s:wipebuf')
