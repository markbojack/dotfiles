...
" Vim session script.
" Created by session.vim 2.13.1 on 25 Tháng 5 2021 at 23:59:17.
...
badd +17 R/getAndProcessSymbols.R
...
wincmd w
argglobal
if bufexists("term://.//3517930:R\ ") | buffer term://.//3517930:R\  | else | edit term://.//3517930:R\  | endif
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
setlocal fdn=20
setlocal fen
let s:l = 10058 - ((57 * winheight(0) + 29) / 58)
...
1resize 58|vert 1resize 31|2resize 58|vert 2resize 80|3resize 58|vert 3resize 108|
3wincmd w
tabnext 1
if exists('s:wipebuf')
