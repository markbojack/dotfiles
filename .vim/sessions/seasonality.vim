...
" Vim session script.
" Created by session.vim 2.13.1 on 23 Tháng 6 2021 at 21:47:48.
...
argglobal
if bufexists("term://.//16628:R\ ") | buffer term://.//16628:R\  | else | edit term://.//16628:R\  | endif
setlocal fdm=manual
setlocal fde=0
setlocal fmr={{{,}}}
setlocal fdi=#
...
setlocal fdn=20
setlocal fen
let s:l = 860 - ((52 * winheight(0) + 26) / 53)
...
setlocal fen
silent! normal! zE
let s:l = 51 - ((41 * winheight(0) + 26) / 53)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
51
