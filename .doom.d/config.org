...
#+description: Personal config.org for Doom Emacs (v2.0.9)
#+author: Mark Bojack
...
** mu4e :TODO:
TODO: auto run mu4e-update-index at start
TODO: if you ever do need to reindex: rm -rfv ~/.mu, mu index
...
TODO: document title height below doesn't work
